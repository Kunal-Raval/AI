        ...
        if 1==1:
            ...
            try:
                ...
                if(angle1 < threshold_angle):  
                    ...
                    x_val = landmarks[mp_pose.PoseLandmark.LEFT_ELBOW.value].x
                    y_val = landmarks[mp_pose.PoseLandmark.LEFT_ELBOW.value].y
                    ...
                    if img_flg:
                        ...
                        print(dt_string)
                        print("EHureka")
                        cv2.imwrite(f'wrong/{curr_set}_{count+1}LEFT_SHOULDER.png', image)
                ...
                if(r_angle1 < threshold_angle):  
                    ...
                    x_val = landmarks[mp_pose.PoseLandmark.RIGHT_ELBOW.value].x
                    y_val = landmarks[mp_pose.PoseLandmark.RIGHT_ELBOW.value].y
                    x, y = int(x_val * w), int(y_val * h)
                    # print(x,y)
                    # cv2.rectangle(frame, (x-50, y-50),
                    #               (x+50, y+50), (0, 0, 255), 2)
                    ...
                    if img_flg:
                        ...
                        print(dt_string)
                        print("EHureka")
                        cv2.imwrite(f'wrong/{curr_set}_{count+1}RIGHT_SHOULDER.png', image)
